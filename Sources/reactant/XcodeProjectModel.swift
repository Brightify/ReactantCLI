...
public struct Xcode {
    ...
    public class Target {
        ...
        @discardableResult public func addResourcesBuildPhase() -> ResourcesBuildPhase {
    ...
    public class BuildSettingsTable {
        ...
        public struct BuildSettingsItem {
            var value: String?
            var sdkSpecificValues: [SDK: String] = [:]

            subscript(sdk: SDK) -> String? {
                get {
                    return sdkSpecificValues[sdk]
                }
                set {
                    sdkSpecificValues[sdk] = newValue
                }
            }
        }
